...
The main API that powers the main UI app. Built with NestJS.
...
## Protecting by if a user belongs to a specific role

Use the keycloak.protect middleware method and pass in a string with "realm:MyRoleHere". ex: `keycloak.protect('realm:Manager')`
